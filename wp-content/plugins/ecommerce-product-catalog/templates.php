...
class ic_catalog_template {
	...
	function initialize_product_adder_template() {
		...
		$all_themes		 = array_merge( $woothemes, $twentyeleven, $twentyten, $twentythirteen, $twentyfourteen, $twentyfifteen, $twentysixteen, $twentyseventeen, $twentynineteen, $third_party, $generic_content );
