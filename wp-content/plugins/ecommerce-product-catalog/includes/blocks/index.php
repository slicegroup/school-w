...
class ic_epc_blocks {
	...
	function enqueue() {
		...
		wp_localize_script( 'ic-epc-show-products', 'ic_epc_blocks', array(
			'strings'				 => array(
				'show_products'		 => sprintf( __( 'Show %s', 'ecommerce-product-catalog' ), $this->singular_name ),
				...
				'choose_products'	 => sprintf( __( 'Choose %s to Display', 'ecommerce-product-catalog' ), $this->singular_name ),
	...
	function render_products( $atts = null ) {
		...
		return show_products_outside_loop( $atts );
	}
