		...
		register_taxonomy(
			...
			apply_filters(
				'woocommerce_taxonomy_args_product_cat', array(
					...
					'label'                 => __( 'School', 'woocommerce' ),
					'labels'                => array(
						'name'              => __( 'Product school', 'woocommerce' ),
						'singular_name'     => __( 'School', 'woocommerce' ),
						'menu_name'         => _x( 'Add School', 'Admin menu name', 'woocommerce' ),
						'search_items'      => __( 'Search school', 'woocommerce' ),
						'all_items'         => __( 'All school', 'woocommerce' ),
						'parent_item'       => __( 'Parent school', 'woocommerce' ),
						'parent_item_colon' => __( 'Parent school:', 'woocommerce' ),
						'edit_item'         => __( 'Edit school', 'woocommerce' ),
						'update_item'       => __( 'Update school', 'woocommerce' ),
						'add_new_item'      => __( 'Add new school', 'woocommerce' ),
						'new_item_name'     => __( 'New school name', 'woocommerce' ),
						'not_found'         => __( 'No school found', 'woocommerce' ),
					),
					'show_ui'               => true,
					'query_var'             => true,
					'capabilities'          => array(
			...
			apply_filters(
				'woocommerce_taxonomy_args_product_tag', array(
					...
					'labels'                => array(
						...
						'menu_name'                  => _x( 'Add Categories', 'Admin menu name', 'woocommerce' ),
						...
						'popular_items'              => __( 'Popular categories', 'woocommerce' ),
						'separate_items_with_commas' => __( 'Separate categories with commas', 'woocommerce' ),
						'add_or_remove_items'        => __( 'Add or remove categories', 'woocommerce' ),
						'choose_from_most_used'      => __( 'Choose from the most used categories', 'woocommerce' ),
